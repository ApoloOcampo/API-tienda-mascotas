...
module.exports.agregar = app.post('/', (req, res) => {
    const { ID_SUSCRIPTOR, FECHA_INICIO, ESTADO_SUSCRIPCION, FECHA_TERMINO, ID_USUARIO, MONTO } = req.body;
    const sql = `INSERT INTO SUSCRIPCION 
                (ID_SUSCRIPTOR, FECHA_INICIO, ESTADO_SUSCRIPCION, FECHA_TERMINO, ID_USUARIO, MONTO) 
                VALUES (?, ?, ?, ?, ?, ?)`;
    const values = [ID_SUSCRIPTOR, FECHA_INICIO, ESTADO_SUSCRIPCION, FECHA_TERMINO, ID_USUARIO, MONTO];
  ...
  module.exports.actualizar = app.patch('/', (req, res) => {
    ...
    const sql = `UPDATE SUSCRIPCION SET 
                ...
                MONTO = ?
                WHERE ID_SUSCRIPTOR = ?`;
    const values = [FECHA_INICIO, ESTADO_SUSCRIPCION, FECHA_TERMINO, ID_USUARIO, MONTO, ID_SUSCRIPTOR];
