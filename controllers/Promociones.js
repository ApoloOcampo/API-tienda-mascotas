...
module.exports.agregar = app.post('/', (req, res) => {
  const { ID_PROMOCIONES, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCUENTO, ESTADO } = req.body;
  const sql = `INSERT INTO PROMOCIONES 
              (ID_PROMOCIONES, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCUENTO, ESTADO) 
              VALUES (?, ?, ?, ?, ?, ?)`;
  const values = [ID_PROMOCIONES, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCUENTO, ESTADO];
...
module.exports.actualizar = app.patch('/', (req, res) => {
  ...
  const values = [NOMBRE, FECHA_INICIO, FECHA_FIN, DESCUENTO, ESTADO, ID_PROMOCIONES];
